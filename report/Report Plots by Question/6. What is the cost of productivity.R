...
ggplot(asylum_costs_and_productivity, aes(x = `Financial Year`, y = `Total Asylum Costs`)) +
  ...
  labs(title = "In 2022, the cost of the system surpassed £2 billion.",
       subtitle = "Cost of the asylum system, 2010/11 to 2021/22", 
       x = "Financial year",
...
Productivity |>
  ...
  geom_point(alpha = 0.5, colour = brc_colours$red_dunant) +
