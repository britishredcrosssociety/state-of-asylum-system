...
NRMTotal %>%
  ...
  theme_brc() +
  labs(title = strwrap("Number of referrals to the National Referral Mechanism (NRM) by age and sex for year ending March 2023"), 
       x = "Sex", 
...
DTNTotal %>%
  ...
  theme_brc() +
  labs(title = str_wrap("Nationalities with the largest number of reports via the Duty to Notify process for year ending March 2023"),
